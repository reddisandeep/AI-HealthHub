...
list_of_files = [
    ...
    "Notebook_Experiments/Breast_Caner_Prediction.ipynb",
    "Notebook_Experiments/Skin_Caner_Prediction.ipynb",
    ...
    "src/Breast_Caner_Prediction/components/__init__.py",
    "src/Breast_Caner_Prediction/components/Data_ingestion.py",
    "src/Breast_Caner_Prediction/components/Data_transformation.py",
    "src/Breast_Caner_Prediction/components/Model_trainer.py",
    "src/Breast_Caner_Prediction/components/Model_evaluation.py",
    "src/Breast_Caner_Prediction/pipelines/__init__.py",
    "src/Breast_Caner_Prediction/pipelines/Prediction_pipeline.py",
    "src/Breast_Caner_Prediction/pipelines/Training_pipeline.py",

    "src/Skin_Caner_Prediction/components/__init__.py",
    "src/Skin_Caner_Prediction/components/Data_ingestion.py",
    "src/Skin_Caner_Prediction/components/Data_transformation.py",
    "src/Skin_Caner_Prediction/components/Model_trainer.py",
    "src/Skin_Caner_Prediction/components/Model_evaluation.py",
    "src/Skin_Caner_Prediction/pipelines/__init__.py",
    "src/Skin_Caner_Prediction/pipelines/Prediction_pipeline.py",
    "src/Skin_Caner_Prediction/pipelines/Training_pipeline.py",
